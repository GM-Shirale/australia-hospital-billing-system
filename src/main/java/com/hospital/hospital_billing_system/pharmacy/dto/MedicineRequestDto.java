...
public class MedicineRequestDto {
    ...
    @Size(
            max = 50,
            message = "Medicine code must not exceed 50 characters"
    )
    ...
    @Size(
            max = 150,
            message = "Generic name must not exceed 150 characters"
    )
    private String genericName;

    @Size(
            max = 150,
            message = "Brand name must not exceed 150 characters"
    )
    ...
    @Size(
            max = 100,
            message = "Strength must not exceed 100 characters"
    )
    ...
    @Size(
            max = 50,
            message = "PBS item code must not exceed 50 characters"
    )
    ...
    @Min(
            value = 0,
            message = "Reorder level must not be negative"
    )
